...
// Skip: Mock repositories removed during production audit (Task 9.1).
// Sales flows are now tested via real E2E Playwright workflows.
describe.skip("salesService (e2e with mock repo — DEPRECATED)", () => {
  it("placeholder", () => {});
});
