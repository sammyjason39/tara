    ...
    return [
      {
        ...
        category: "STOCK",
        value: String(dashboard.total_on_hand_qty || 0),
      },
      {
        id: "inv-ins-2",
      ...
      },
      {
        ...
        label: "Expiry alerts",
        category: "RISK",
        value: String(dashboard.expiry_warning_count || 0),
      },
      {
        id: "inv-ins-5",
        label: "Pending adjustments",
        category: "GOVERNANCE",
        value: String(dashboard.pending_adjustments || 0),
      },
      {
        id: "inv-ins-6",
        label: "Pending procurement receipts",
        category: "INTEGRATION",
        value: String(dashboard.pending_receipt_syncs || 0),
      },
      {
        id: "inv-ins-7",
