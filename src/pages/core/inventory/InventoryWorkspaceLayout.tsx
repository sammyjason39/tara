...
const SECTIONS: MenuSection[] = [
  {
    title: "Operations",
    items: [
      { label: "Inventory Dashboard", to: "/core/inventory/dashboard", icon: Boxes },
      { label: "Stock Hub", to: "/core/inventory/stock", icon: ScanLine },
      { label: "Receiving Desk", to: "/core/inventory/receiving", icon: ActivitySquare },
      { label: "Adjustments", to: "/core/inventory/adjustments", icon: ClipboardCheck },
    ],
  },
  {
    title: "Governance",
    items: [{ label: "Audit Log", to: "/core/inventory/audit", icon: ShieldCheck }],
  },
  {
    title: "Intelligence",
    items: [{ label: "Inventory Insights", to: "/core/inventory/insights", icon: BarChart3 }],
  },
];
          ...
          <div className="space-y-3">
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbItem>
                  <BreadcrumbLink asChild>
                    <Link to="/core/inventory">Inventory</Link>
                  </BreadcrumbLink>
                </BreadcrumbItem>
            ...
            <PageHeader
              ...
              subtitle="Central stock hub with location/department controls, receiving sync, and audit-grade governance."
