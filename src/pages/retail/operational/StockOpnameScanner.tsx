          ...
          <div className="lg:col-span-3 space-y-6">
              ...
              <CardContent className="pt-12 pb-14">
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-slate-500 font-black tracking-widest uppercase mt-1 opacity-60">
                      Scanning Zone: [MAIN_FLOOR]
                    </p>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="shadow-2xl border-slate-200 flex flex-col h-[450px] rounded-[2rem] overflow-hidden">
                <CardHeader className="p-8 border-b bg-slate-50/80">
                  <CardTitle className="text-sm font-black text-slate-600 uppercase tracking-[0.2em] flex items-center justify-between italic">
                    Live Session Stream
                    <Badge className="bg-blue-600 text-white font-black italic px-4">
                      {history.length} SKUs
                    </Badge>
                  </CardTitle>
                </CardHeader>
                  ...
                  <ScrollArea className="h-full p-6">
                    {isLoading ? (
                      ...
                      <div className="h-full flex flex-col items-center justify-center text-slate-300 py-20">
                        ...
                        <p className="text-[10px] font-black italic uppercase tracking-[0.2em]">
                          ...
                          return (
                            ...
                            >
                              <div className="flex gap-4">
                                <div
                                  className={`w-12 h-12 rounded-xl flex items-center justify-center shadow-inner ${hasVariance ? "bg-amber-100" : "bg-slate-100"}`}
                                >
                                  <Box
                                    className={`w-6 h-6 ${hasVariance ? "text-amber-600" : "text-slate-400"}`}
                                  />
                                </div>
                                <div className="min-w-0">
                                  ...
                                  <div className="text-[10px] font-bold text-slate-500 uppercase leading-none mt-2 tracking-tighter">
                              ...
                              <div className="text-right">
                                ...
                                <div
                                  className={`text-[10px] font-black uppercase tracking-tighter ${hasVariance ? "text-amber-600" : "text-emerald-600"}`}
                                >
                                  {hasVariance
                                    ? `${scan.actualCount - scan.systemCount} VARIANCE`
                                    : "IN-SYNC"}
                                </div>
                              </div>
                            </div>
              ...
              <Card className="shadow-2xl border-slate-200 bg-slate-50/50 rounded-[2rem] flex flex-col">
                <CardHeader className="p-8 border-b bg-slate-50/80">
                  <CardTitle className="text-sm font-black text-slate-600 uppercase tracking-[0.2em] italic">
                    Operational Metrics
                  </CardTitle>
                </CardHeader>
                <CardContent className="p-8 space-y-8 flex-1">
                  ...
                  <div className="space-y-4 pt-4">
                    ...
                    <div className="w-full bg-slate-200 h-3 rounded-full overflow-hidden shadow-inner">
                      <div
                        ...
                        style={{
                          width: `${history.length > 0 ? (totalVarianceCount / history.length) * 100 : 0}%`,
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <p className="text-[10px] text-center text-slate-400 font-bold italic px-4 uppercase tracking-tighter leading-relaxed">
                    Submission triggers automated{" "}
                    <span className="text-slate-900">Fiscal Adjustments</span>{" "}
                    <br /> within the Finance Ledger.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="space-y-6">
            <Card className="bg-slate-900 text-white border-none shadow-3xl relative overflow-hidden rounded-[2.5rem]">
              ...
              <CardHeader className="p-8 pb-4">
                <CardTitle className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-400 italic">
                  Gatehouse Pulse
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-8 pb-10 px-8">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-sm font-black italic uppercase tracking-tighter text-white">
                    EDGE_GATEWAY: [REAL_TIME]
                  </span>
                </div>
                <div className="space-y-4">
                  <div className="p-5 bg-white/5 rounded-2xl border border-white/10 shadow-inner">
                    <div className="text-[9px] font-black text-slate-500 uppercase mb-2 tracking-widest">
                      Hardware Context
                    </div>
                    <div className="text-sm font-mono font-black text-blue-400 italic">
                      ZVX-SCAN-PRO-992
                    </div>
                  </div>
            ...
            <Card className="border-amber-100 bg-amber-50/20 rounded-[2rem] border-2">
              <CardContent className="p-6 flex gap-4">
                ...
                <div>
                  <div className="text-[10px] font-black text-amber-900 uppercase italic tracking-widest">
                    Audit Restriction
                  </div>
                  <p className="text-[11px] text-amber-800 font-bold mt-2 leading-relaxed italic">
                    Discrepancies exceeding{" "}
                    <span className="underline">±15%</span> will lock the zone
                    for manual supervisor verification.
                  </p>
                </div>
              </CardContent>
            </Card>
