...
CREATE TABLE "asset_depreciation_entries" (
    ...
    "depreciation_exp" DECIMAL(20,2) NOT NULL,
    "accumulated_dep" DECIMAL(20,2) NOT NULL,
...
CREATE TABLE "capex_budgets" (
    ...
    "committed_budget" DECIMAL(20,2) NOT NULL DEFAULT 0,
    "available_budget" DECIMAL(20,2) NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "cost_layers" (
    ...
    "remaining_qty" DECIMAL(20,2) NOT NULL,
...
CREATE TABLE "cost_snapshots" (
    ...
    "total_valuation" DECIMAL(20,2) NOT NULL,
    "avg_unit_cost" DECIMAL(20,2) NOT NULL,
    "currency" TEXT NOT NULL DEFAULT 'USD',
...
CREATE TABLE "finance_account_balances" (
    ...
    "net_balance" DECIMAL(20,2) NOT NULL DEFAULT 0,
    "version" INTEGER NOT NULL DEFAULT 1,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "finance_expense_policies" (
    ...
    "hard_limit" DECIMAL(20,2) NOT NULL,
    "soft_limit" DECIMAL(20,2) NOT NULL,
...
CREATE TABLE "fixed_assets" (
    ...
    "carrying_value" DECIMAL(20,2) NOT NULL,
    "revaluation_reserve" DECIMAL(20,2) NOT NULL DEFAULT 0,
...
CREATE TABLE "hr_benefit_plans" (
    ...
    "type" TEXT NOT NULL,
    "description" TEXT,
    "employer_contribution" DECIMAL(20,2),
    "employee_contribution" DECIMAL(20,2),
...
CREATE TABLE "hr_headcount_plans" (
    ...
    "projected_salary" DECIMAL(20,2) NOT NULL,
...
CREATE TABLE "hr_payroll_runs" (
    ...
    "total_gross_pay" DECIMAL(20,2) NOT NULL DEFAULT 0,
    "total_net_pay" DECIMAL(20,2) NOT NULL DEFAULT 0,
...
CREATE TABLE "item_masters" (
    ...
    "tax_rate" DECIMAL(20,2) NOT NULL DEFAULT 0.11,
    "image_url" TEXT,
...
CREATE TABLE "job_roles" (
    ...
    "code" TEXT NOT NULL,
    "description" TEXT,
    "base_salary_min" DECIMAL(20,2),
    "base_salary_max" DECIMAL(20,2),
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "marketing_attribution" (
    ...
    "opportunity_id" TEXT,
    "revenue_attributed" DECIMAL(20,2) NOT NULL,
...
CREATE TABLE "money_sources" (
    ...
    "currency" TEXT NOT NULL DEFAULT 'IDR',
    "balance" DECIMAL(20,2) NOT NULL,
    "pending_settlement" DECIMAL(20,2) NOT NULL DEFAULT 0,
    "provider" TEXT,
...
CREATE TABLE "payment_providers" (
    ...
    "channels" TEXT[],
    "status" TEXT NOT NULL DEFAULT 'HEALTHY',
    "max_amount_per_txn" DECIMAL(20,2) NOT NULL,
...
CREATE TABLE "procurement_draft_pos" (
    ...
    "quoted_total" DECIMAL(20,2) NOT NULL,
...
CREATE TABLE "retail_shifts" (
    ...
    "opening_cash" DECIMAL(20,2) NOT NULL,
    "closing_cash" DECIMAL(20,2),
...
CREATE TABLE "sales_leads" (
    ...
    "owner_name" TEXT NOT NULL,
    "score" INTEGER NOT NULL DEFAULT 0,
    "potential_value" DECIMAL(20,2) NOT NULL,
    "currency" TEXT NOT NULL DEFAULT 'IDR',
    "priority" TEXT NOT NULL DEFAULT 'MEDIUM',
...
CREATE TABLE "sales_quotes" (
    ...
    "version" INTEGER NOT NULL DEFAULT 1,
    "amount" DECIMAL(20,2) NOT NULL,
    "discount_percent" DECIMAL(20,2) NOT NULL DEFAULT 0,
...
CREATE TABLE "customer_credit_balances" (
    ...
    CONSTRAINT "customer_credit_balances_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "ledger_event_logs" (
    "id" TEXT NOT NULL,
    "tenant_id" TEXT NOT NULL,
    "company_id" TEXT,
    "event_type" TEXT NOT NULL,
    ...
    CONSTRAINT "ledger_event_logs_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "customer_credit_balances_tenant_id_idx" ON "customer_credit_balances"("tenant_id");

-- CreateIndex
CREATE UNIQUE INDEX "customer_credit_balances_tenant_id_customer_id_key" ON "customer_credit_balances"("tenant_id", "customer_id");

-- CreateIndex
CREATE INDEX "ledger_event_logs_tenant_id_status_idx" ON "ledger_event_logs"("tenant_id", "status");

-- CreateIndex
CREATE INDEX "ledger_event_logs_tenant_id_company_id_status_idx" ON "ledger_event_logs"("tenant_id", "company_id", "status");

-- CreateIndex
CREATE UNIQUE INDEX "ledger_event_logs_tenant_id_company_id_source_event_id_key" ON "ledger_event_logs"("tenant_id", "company_id", "source_event_id");
