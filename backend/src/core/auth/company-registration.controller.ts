...
export class CompanyRegistrationController {
  constructor(private readonly registrationService: CompanyRegistrationService) {}

  @Post('provision')
  async provisionCompany(@Req() request: RequestWithUser, @Body() dto: CreateCompanyDto) {
